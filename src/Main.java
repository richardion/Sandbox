...
import SandboxModele.Animal;
import SandboxModele.Cage;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        MenuView view=new MenuView(MaMenagerie);
        Controller control=new Controller(view, MaMenagerie);
//            Cage maCage = new Cage("135486");
//            Animal kiki = new Animal("Chien", "Kiki");
//            maCage.ajouterAnimal(kiki);
//            maCage.afficherAnimal();
//            Animal prout = new Animal("tirelipimpon", "Connard");
//            maCage.ajouterAnimal(prout);
